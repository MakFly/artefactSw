...
{
    public static function getSubStatRankingByTwo($value)
    {
        $rank = [
            "id" => $value->getId(),
    ...
    public static function getSubStatRankingByOne($value)
    {
        $rank = [
            "id" => $value->getId(),
    ...
    public static function getSubStatRankingByZeroPointFive($value)
    {
        $rank = [
            "id" => $value->getId(),
        ...
        switch($filterSubStats) {
            case 1:
                if ($skills->getSkill1critdmgmorepourcent() == 2) {
                    $rankingChangeSubStat[] = $this->getSubStatRankingByTwo($value);
                }
                if ($skills->getSkill1critdmgmorepourcent() == 1) {
                    $rankingChangeSubStat[] = $this->getSubStatRankingByOne($value);
                }
                if ($skills->getSkill1critdmgmorepourcent() == 0) {
                    $rankingChangeSubStat[] = $this->getSubStatRankingByZeroPointFive($value);
                }
                break;
            case 2:
